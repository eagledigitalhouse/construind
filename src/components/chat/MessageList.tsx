...
import { formatTime } from '../../data/chatData';
...
const MessageList: React.FC<MessageListProps> = ({ message, contact, profile }) => {
      ...
      {senderId === 11 ? (
        ...
        <div className="flex space-x-2 items-start justify-end group w-full rtl:space-x-reverse">
          <div className="no flex space-x-4 rtl:space-x-reverse">
            <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible">
              <div className="h-8 w-8 bg-indigo-100 dark:bg-gray-900 dark:text-gray-400 flex flex-col justify-center items-center text-xl rounded-full text-indigo-500 cursor-pointer">
        ...
        <div className="flex space-x-2 items-start group rtl:space-x-reverse">
          ...
          <div className="flex-1 flex space-x-4 rtl:space-x-reverse">
            ...
            <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible">
              <div className="h-8 w-8 bg-gray-100 dark:bg-gray-900 dark:text-gray-400 text-gray-900 flex flex-col justify-center items-center text-xl rounded-full cursor-pointer">
                <MoreHorizontal className="w-4 h-4" />
              </div>
            </div>
          </div>
